...
function initPushwoosh() {
	...
	pushNotification.registerDevice({alert:true, badge:true, sound:true, pw_appid:"DD7C1-014A4", appname:"Ultra Tune Alexandria"},
									function(status) {
